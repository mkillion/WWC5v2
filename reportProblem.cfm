...
<cfoutput>
    <cfmail to = "killion.kgs@gmail.com" from = "killion@kgs.ku.edu" replyto="killion@kgs.ku.edu" subject = "WWC5 Mapper Data Problem" type="html">
    	...
    	MESSAGE: #form.msg#<p>
    	*** this message is auto-generated by the WWC5 mapper ***
	</cfmail>
</cfoutput>
